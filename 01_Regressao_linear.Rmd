...
corrgram(cars, order = TRUE, lower.panel = panel.shade,
         ...
         main = "Carros")
```
Gerar o modelo usando função lm
Querendo prever a velocidade que o carro estava baseado na distância de parada
...
abline(modelo)
```
Pode-se fazer uma previsão usando diretamente os coeficientes
